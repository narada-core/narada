...
const NATIVE_SURFACES = ['site-lifecycle-mcp', 'site-registry-mcp', 'project-state-mcp'] as const;

test('native profile admits the Rust site-management surfaces', () => {
...
test('all admitted profiles preserve explicit alternatives for the Rust site-management surfaces', () => {
