...
$names = @('window-surface-overlay.ps1', 'WindowSurfaceOverlayTiling.ps1', 'Start-WindowSurfaceOverlay.ps1', 'Stop-WindowSurfaceOverlay.ps1', 'Inspect-WindowSurfaceOverlay.ps1')
